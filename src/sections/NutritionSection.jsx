...
const NutritionSection = () => {
  ...
  return (
    <section className="nutrition-section">
      ...
      <img src="/images/hero-image.png" alt="" className="big-img" />

      <div className="flex md:flex-row flex-col justify-between md:px-10 px-5 mt-14 md:mt-0">
        <div className="relative inline-block md:translate-y-20">
          <div className="general-title relative flex flex-col justify-center items-center gap-24">
            <div className="overflow-hidden place-self-start">
              <h1 className="nutrition-title">Our Brews</h1>
            </div>
            <div
              style={{
            ...
            >
              <div className="bg-yellow-brown pb-5 md:pt-0 pt-3 md:px-5 px-3">
                <h2 className="text-milk-yellow">Taste & Quality</h2>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex md:justify-center items-center translate-y-5">
          <div className="md:max-w-xs max-w-md">
              ...
              Hand-blended leaves, authentic flavors, and consistent quality
              across every cup.
            </p>
          </div>
        </div>
